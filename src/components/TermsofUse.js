        ...
        return (
            <React.Fragment>
                ...
                <div className="container epage"  style={{ minHeight: "350px" }}>
                    ...
                    In respect of any transactions entered into on the PUBG KHELO platform, including making a payment to participate in the paid versions of Contest(s), Users agree to be bound by the following payment terms: The payment of pre-designated amount Users make to participate in the Contest(s) is inclusive of the pre-designated platform fee for access to the PUBG KHELO Services charged by PUBG KHELO and pre-determined participant’s contribution towards prize money pool.
