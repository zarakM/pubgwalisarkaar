                    ...
                    {this.state.mine.map((items, key) => (
                        <div>
                            <div className="card" key={items.id}>
                                ...
                                {/* <div className="carditems"><Link className="button btn-info" to={"/ideas/${items.id}"}>Create Idea</Link></div> */}
{/* <button  key={items.id} onClick={this.Leaderboard.bind(this,items.id)}>Leaderboard</button> */}
                            </div><br /></div>
                    ))}
                    <br />
                </div>
